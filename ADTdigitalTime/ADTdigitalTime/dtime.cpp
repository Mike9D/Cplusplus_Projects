                                 ...
                                 int& hours_in_interval,  int& minutes_in_interval)  const
{
    ...
    hours_in_interval=hour-previous_time.hour;
    if (hours_in_interval < 0)
       hours_in_interval += 24;
    else
        hours_in_interval=(hour-previous_time.hour)-1;
    
    
    
    if(minute>previous_time.minute)
        minutes_in_interval=minute-previous_time.minute;
    else
        minutes_in_interval=60-previous_time.minute;
