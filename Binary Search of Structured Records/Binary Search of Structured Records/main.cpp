...
//  Inputs: The program needs to take in a sorted list. The program only works if the list is sorted, non-sorted lists will not work correctly as intended.

// Outputs: Based on the chosen abbreviation, the program will output how many tries it takes to get to your state.
//
...
#include <iostream>
//#include <ctring>       // you may need this include to use stricmp or strcasecmp for C++
#include <string.h>     //  -- or you may need this one for C
using namespace std;
...
int main(int argc, char* argv[])
{
    ...
    int imid = (imin + imax) / 2;  // midpoint for roughly equal parts
